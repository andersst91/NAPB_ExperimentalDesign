...
```{r eval=T,message=F}
# You can download the csv file from the google drive link below

# G2F<-read.csv("C:\\Users\\steve\\OneDrive\\CS17_G2F_Data.csv",
#               header=T,
#               stringsAsFactors = F)

# To load the G2F data please adjust the path to refelct where you downloaded and extracted the CS17-G2F.RData from the git hub repository clone
